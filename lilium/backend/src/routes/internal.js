...
const internal_user_service_1 = require("../services/internal-user.service");
const internal_auth_1 = require("../middleware/internal-auth");
const client_1 = require("@prisma/client");
const internalRoutes = async (fastify) => {
    const internalService = new internal_user_service_1.InternalUserService(fastify);
    ...
    fastify.post('/users/vendor', {
        preHandler: [internal_auth_1.authenticateInternal],
        schema: {
            tags: ['internal'],
    ...
    fastify.get('/zones', {
        ...
        return reply.send({
            success: true,
            zones: Object.values(client_1.Zone),
    ...
    fastify.get('/roles', {
        ...
        return reply.send({
            success: true,
            roles: {
                dashboard: [client_1.UserRole.COMPANY_ADMIN, client_1.UserRole.COMPANY_ADMIN],
                mobile: [client_1.UserRole.SHOP_OWNER]
            },
