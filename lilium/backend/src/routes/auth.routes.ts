...
const authRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.post('/register/mobile', {
    ...
    const result = await authService.registerMobile(request.body as any);
    return reply.code(201).send(result);
  });
  ...
  fastify.post('/otp/request', {
    ...
    await authService.sendOtp((request.body as any).phone);
  ...
  fastify.post('/otp/login', {
    ...
    const result = await authService.loginWithOtp(request.body as any);
    return reply.send(result);
  });
  ...
  fastify.put('/password/update', {
    ...
    await authService.updatePassword(request.user!.userId, request.body as any);
