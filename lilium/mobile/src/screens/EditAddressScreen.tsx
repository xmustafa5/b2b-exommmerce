...
export const EditAddressScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  if (!address) {
    return (
      <View style={styles.centerContainer}>
        <Text style={styles.errorMessage}>Address not found</Text>
  ...
  return (
    ...
    >
      ...
      <View style={styles.bottomContainer}>
        <TouchableOpacity
          style={[styles.saveButton, updateAddress.isPending && styles.saveButtonDisabled]}
